  ...
  <html>
    ...
    <body>
      ...
      <section class="container_100">
        <div id="favoriteDiv" class="visible_div">
          <h3>Favorite</h3>
          <button
            @click="showDiv(1)"
            id="makeVisible"
        ...
        <div id="hiddenDiv_1" v-if="isShowing == 1">
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="favoriteItem in favoriteItems" :key="favoriteItem.id">
                <th scope="row">{{ booking.id }}</th>

                <td>{{ favoriteItem.product_id }}</td>
                <td>{{ favoriteItem.user_id }}</td>
      ...
      <section class="container_100">
        <div class="updateDiv">
          <select class="form-control">
            <option selected disabled value="">Product ID</option>
            <option>Cello</option>
